...
public class BuiltinClimateRanges extends DataManagerProvider<ClimateRange> {
    ...
    protected void addData(HolderLookup.Provider provider) {
        add(ClimateRanges.MUSHROOMS, Mushrooms.PORTOBELLO, b -> b.hydration(10, 60).temperature(-14.8f, 16.6f));
        add(ClimateRanges.MUSHROOMS, Mushrooms.FLY_AGARIC, b -> b.hydration(10, 60).temperature(-14.8f, 16.6f));
        add(ClimateRanges.MUSHROOMS, Mushrooms.CHICKEN_OF_THE_WOODS, b -> b.hydration(10, 60).temperature(-14.8f, 16.6f));
    }
