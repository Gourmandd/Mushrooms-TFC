package com.gourmandd.mushrooms_tfc.item;
...
public class MushroomBlockItem extends BlockItem implements PlantableInfo {

    private final Supplier<ClimateRange> climateRange;
    private final List<Lifecycle> stages;

    public MushroomBlockItem (Block block, Supplier<ClimateRange> range, Lifecycle[] stages)
    {
